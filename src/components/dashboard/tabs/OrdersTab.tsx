        ...
        <div className="flex flex-col gap-6">
          <div className="grid grid-cols-1 gap-6">
            {myOrders.map((order: Order) => (
              <div 
                key={order.id} 
                className="p-8 bg-white/[0.03] border border-white/5 rounded-[3rem] hover:bg-white/[0.05] transition-all group relative overflow-hidden"
              >
                <div className="flex flex-col xl:flex-row justify-between gap-10">
                  <div className="flex-1 space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center border border-white/10 font-black text-zinc-500 text-xl group-hover:text-blue-500 transition-colors overflow-hidden">
                        ...
                        <div>
                          ...
                          <h4 className="text-2xl font-black text-white italic uppercase tracking-tighter">{order.supplier?.company_name || t('supplier')}</h4>
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-2xl font-black text-white italic">{formatCurrency(order.total_amount || 0, order.currency || 'USD', locale)}</p>
                      </div>
                    </div>
                  ...
                  <div className="xl:w-72 flex flex-col justify-between gap-4 border-t xl:border-t-0 xl:border-l border-white/5 pt-8 xl:pt-0 xl:pl-8">
                    <div className="space-y-4">
                      <button 
                        ...
                        className="w-full py-4 bg-white/5 hover:bg-white/10 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest border border-white/10 transition-all flex items-center justify-center gap-3"
                      >
